...
Local Fernet / protocol checks against LuminaSync-core Python crypto.

| Script | Purpose |
|--------|---------|
| `test-fernet-roundtrip.ts` | TS encrypt/decrypt round-trip |
| `test-fernet-cmds-export.ts` | Writes `.test-wires.txt` for `LuminaSync-core/scripts/test_fernet_cmds.py` |

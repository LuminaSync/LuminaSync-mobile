...
import { CameraView, useCameraPermissions, type ScanningOptions } from "expo-camera";
...
export function PairScreen({ onPaired }: Props) {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.portHint}>Use port {DEFAULT_REMOTE_PORT} on the PC (fixed)</Text>



      <Pressable style={styles.linkBtn} onPress={() => void openQrScanner()} disabled={busy}>
      ...
      >
        ...
        <View style={styles.modalRoot}>
          ...
          <Text style={styles.modalTitle}>Scan PC QR</Text>
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.accent, fontSize: 22, fontWeight: "700", marginBottom: 8 },
  ...
  portHint: { color: colors.muted, fontSize: 12, textAlign: "center", marginBottom: 16 },
  ...
  modalTitle: { color: colors.accent, fontSize: 18, fontWeight: "600", marginBottom: 12 },
